...
{
    public class ContractTextRepository : SAIC_FTSRepositoryBase<ContractText>, IContractTextRepository
    {
        public ContractTextRepository(IDbContextProvider<SAIC_FTSDbContext> dbContextProvider)
        ...
        */
        public List<ContractText> GetAllWithContractNumber(string contractNumber)
        {
            var query = GetAll();
            ...
            {
                query = query.Where(contract => contract.ContractNumber.Equals(contractNumber));
            }
