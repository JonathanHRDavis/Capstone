    ...
    angular.module('app').controller(controllerId, [
        ...
        function ($rootScope, $state, appSession) {
            ...
            vm.menuItems = [
                ...
                createMenuItem(App.localize("Search"), "", "search", "search"), //Full List of menu icons avaiable at https://material.io/icons/
                createMenuItem(App.localize("Data"), "", "storage", "data"),
                createMenuItem(App.localize("Help"), "", "help", "help"),
                /*createMenuItem(App.localize("TestPage"), "", "info", "test")
                ...
                createMenuItem(App.localize("MultiLevelMenu"), "", "menu", "", [
                    createMenuItem("ASP.NET Boilerplate", "", "", "", [
                        createMenuItem("Home", "", "", "https://aspnetboilerplater.com/?ref=abptmpl"),
                        createMenuItem("Google", "", "", "https://google.com"),
